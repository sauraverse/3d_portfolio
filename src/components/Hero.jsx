...
const Hero = () => {
  ...
  <div className="flex-[1.5] flex flex-col items-start gap-5 p-6 sm:p-10 lg:pl-10 lg:pr-1 lg:pt-40 xl:pl-15 xl:pr-5 xl:pt-40"> 
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mt-8">
        <a href="https://drive.google.com/file/d/1X-EDXsFt0YHGzzYsqQ5_Q020AI1cbxDW/view?usp=sharing" target="_blank"><button className="ring-4 ring-purple-700/50 text-lg bg-zinc-900 py-2 px-4 rounded-xl outline-none font-bold hover:shadow-xl hover:shadow-slate-800 hover:bg-slate-900">
