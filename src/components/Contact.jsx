  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="italic">Hey there! Whether you're a Recruiter or a fellow friend, <span className="font-bold text-purple-500">I'd love to hear from you</span>. Leave a message and let me know, you stopped by. Or, if you prefer to stay mysterious, that's cool too! <span className="not-italic">👻</span></p>
        <form
          ref={formRef}
